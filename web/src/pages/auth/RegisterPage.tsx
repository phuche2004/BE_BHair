...
export default function RegisterPage() {
  ...
  const [role, setRole] = useState<'CUSTOMER' | 'MANAGER' | 'STAFF'>('CUSTOMER');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!fullName.trim() || !phoneNumber.trim() || !password || !confirmPassword) {
    ...
    try {
      ...
      const loginData = await authApi.login(phoneNumber.trim(), password);
  ...
  return (
    <div className="auth-page-premium">
      <ParticlesBackground />
      <div className="auth-card" style={{ maxWidth: 440, padding: '32px 32px' }}>
        {/* Logo */}
        <div style={{ marginBottom: 24 }}>
          <div className="auth-logo">B_Hair</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div className="input-group">
              ...
              <div className="input-icon-wrap">
                <span className="input-icon" style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
            ...
            <div className="input-group">
              ...
              <div className="segment" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <button
                  type="button"
                  className={`segment-btn${role === 'CUSTOMER' ? ' active' : ''}`}
                  onClick={() => setRole('CUSTOMER')}
                  style={role === 'CUSTOMER' ? { background: 'rgba(255,255,255,0.1)' } : { color: 'rgba(255,255,255,0.6)' }}
                >
                  {t('auth.customer')}
                </button>
                <button
                  ...
                  style={role === 'MANAGER' ? { background: 'rgba(255,255,255,0.1)' } : { color: 'rgba(255,255,255,0.6)' }}
                >
                  {t('auth.manager')}
                </button>
                <button
                  ...
                  style={role === 'STAFF' ? { background: 'rgba(255,255,255,0.1)' } : { color: 'rgba(255,255,255,0.6)' }}
                >
                  {t('auth.barber')}
                </button>
              </div>
        ...
        {/* Divider */}
        <div className="divider-text" style={{ margin: '20px 0' }}>{t('auth.continueGoogle')}</div>
