...
import { getNext7Days, toDateStr, getStatusClass } from '../../utils/format';
                ...
                <div key={index} className="time-slot">
                  <div className="time-col">
                    ...
                    <button 
                      ...
                      style={{ padding: '4px 8px', borderRadius: 20, minWidth: 32 }}
                      onClick={() => alert('Tính năng thêm lịch hẹn sắp ra mắt')}
                    >
                      +
                    </button>
                  </div>
