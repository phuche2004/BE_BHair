...
if (webDistExists) {
    (0, logger_1.startupLog)('✅ Serving Frontend from web/dist');
    ...
    (0, logger_1.startupLog)('⚠️ Frontend not found at web/dist - API-only mode');
}
...
app.post('/api/deploy', (req, res) => {
    ...
    try {
        (0, child_process_1.execSync)('git fetch origin production && git reset --hard origin/production', {
        ...
        (0, child_process_1.execSync)('pm2 restart BE_BHair_SQLite', {
...
httpServer.listen(PORT, HOST, () => {
    (0, logger_1.startupLog)(`\x1b[32m\x1b[1m✓ B_Hair API\x1b[0m  http://192.168.110.117:${PORT}`);
});
exports.default = app;
